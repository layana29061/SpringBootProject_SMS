...
<body>
    <form action="/updatePhoneNumber" method="post">
        ...
        <input type="tel" id="newPhoneNumber" name="newPhoneNumber" placeholder="Enter new phone number">
	...
	<div class="main--content">
		...
		<div class="row">
			...
			<div class="col-6 ml-4">
				<form method="post" action="/updatePhoneNumber">
					<div class="form-row">
						<div class="form-group col-md-6">
							<input type="hidden" name="staffId" value="${staffId}"> <label
								for="newPhoneNumber">New Phone Number</label> <input type="tel"
