				...
				<form method="post">
					<div class="form-row">
						<div class="form-group col-md-6">
							<label for="subjectId">Subject ID</label> <input type="number"
								class="form-control" name="subjectId"
								value="${subject.subjectId}" placeholder="Enter Subject ID">
						</div>
						<div class="form-group col-md-6">
							<label for="subjectName">Subject Name</label> <input type="text"
								class="form-control" name="subjectName"
								value="${subject.subjectName}" placeholder="Enter subject Name">
						</div>
					</div>
