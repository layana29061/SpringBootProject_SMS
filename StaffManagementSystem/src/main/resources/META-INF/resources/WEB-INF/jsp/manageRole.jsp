...
<body>
	...
	<div class="sidebar">
		...
		<ul class="menu">
			...
			<li><a href='manageSubject'> <i class="fa-solid fa-book"></i>
					<span>Subject</span>
			</a></li>
			<li><a href='manageRole'> <i class="fa-solid fa-users"></i>
					<span>Roles</span>
			</a></li>
	...
	<div class="main--content">
		<div class="header--wrapper">
			...
			<div class="date--box">
				<a href="addRole" class="btn custom-btn">Add Role Details</a>
			</div>
		</div>
		<div class="row">
			<div class="col-12">
					...
					<table
						...
						<tbody>
							<c:forEach var="role" items="${role}">
								<tr>
									<td>${role.roleId}</td>
									<td>${role.staffPosition}</td>
									<td>${role.staffYearOfExperience}</td>
									<td>${role.salary}</td>
									<td><a href="deleteRole?roleId=${role.roleId}"
										class="btn btn-warning"> DELETE </a></td>
									<td><a href="updateSalary?roleId=${role.roleId}"
