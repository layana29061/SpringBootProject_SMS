					...
					<div class=form-group col-md-6>
						<div class="form-group col-md-6">
							<label for="staffId">Staff ID</label> <input type="number"
								class="form-control" name="staffId" value="${staff.staffId}"
								placeholder="Enter Staff ID">
						</div>
						<div class="form-group col-md-6">
							<label for="staffName">Staff Name</label> <input type="text"
								class="form-control" name="staffName" value="${staff.staffName}"
								placeholder="Enter Staff Name">
						</div>
						<div class="form-group col-md-6">
							<label for="staffEmail">Staff Email</label> <input type="email"
								class="form-control" name="staffEmail"
								value="${staff.staffEmail}" placeholder="Enter Staff Email">
						</div>
						<div class="form-group col-md-6">
							<label for="staffPhoneNumber">Phone Number</label> <input
								type="tel" class="form-control" name="staffPhoneNumber"
						...
						<div class="form-group col-md-6">
							<label for="roleId">Role ID</label> <input class="form-control"
								value="${staff.roleId}" name="roleId" placeholder="Enter Id">
						</div>
						<div class="form-group col-md-6">
						...
						<div class="form-group col-md-6">
							<label for="subjectId">Subject ID</label> <input
								class="form-control" value="${staff.subjectId}" name="subjectId"
